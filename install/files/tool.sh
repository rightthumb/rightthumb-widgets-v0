...
# unset mydic
# declare -A mydic2
# # mydic2['bashrc.py']=$widgets/widgets/python/src/unity/bashrc.py
...
function loadVars(){
    ...
    if [ ! -d $widgets/widgets/python/src/unity ]; then
        mkdir $widgets/widgets/python/src/unity
    fi
...
function post_initializer() {
    ...
    # [ ! -d $widgets/widgets/python/src/unity ] && mkdir $widgets/widgets/python/src/unity
    # chmod -R $HOME/.rt  > /dev/null
    # chmod -R 777 $HOME/.rt/*  > /dev/null
    # # chmod -R 777 $widgets  > /dev/null
    # cp -r  ../python/src/unity/_rightThumb/ ./
    # $PY ./shCleanSimple.py
    # subject_path=$widgets/widgets
    # echo $subject_path
    # cp -rf ../bash $subject_path/
    # cp -rf ../python/src/unity/ $subject_path/python/src/
    ...
    # cd $widgets/widgets/python/src/unity
    # echo $widgets/widgets/python/src/unity
    # echo $PY $widgets/widgets/python/src/unity/bashrc.py
