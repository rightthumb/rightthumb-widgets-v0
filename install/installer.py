...
def loader():
	...
	v.vVv = {
				...
				'tt': '[widgets]/widgets/databank/tables', 
...
alias .git.="rm -rf rightthumb-widgets-v0 ; git clone https://github.com/rightthumb/rightthumb-widgets-v0 ; cd rightthumb-widgets-v0 ; chmod 777 -R . ; p shClean -folder -r"
