...
class CLIP:
	...
	def _save_clip_(self,n=''):
		...
		_.pr('To toggle paste: clip-auto', n, fi, c='yellow')
		_paste = _.regImp( __.appReg, '-paste' ); _paste.imp.dirty=True; _.saveText(_paste.imp.paste(),fi)
