...
_.appInfo[focus()] = {
	'file': 'ssl_socket_bridge_client_user_administrator_logs_b.py',
	'liveAppName': __.thisApp( __file__ ),
	'description': 'ssl bridge client admin logs',
	'categories': [
						'ssl',
						'bridge',
						'client',
	...
	def establish( self ):
		if not self.run_establish_connection:
			...
			self.credentials = {
										'user': 'logs',
										'groups': ['system'],
										'password': 'MKDB-B3zkzbxu4kBptEUnDUfi3NPI61ntYFOsbn0lBI=',
