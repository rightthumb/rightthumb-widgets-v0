...
_.appInfo[focus()] = {
	'file': 'decimal_count.py',
	'liveAppName': __.thisApp( __file__ ),
	'description': 'Counts values before and after decimal. Used for EPOCH patterns',
	'categories': [
						'epoch',
						'decimal',
						'tool',
	...
	'examples': [
						'p ls -json -r | p line + dcr dmr dar -or --c | p simpleList  -split ":" 1 -r , | p simpleList | p decimal_count | p countEach',
						'',
	],
	'columns': [
