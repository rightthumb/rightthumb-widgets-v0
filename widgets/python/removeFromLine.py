...
def appSwitches():
	pass
	### EXAMPLE: START
	_.switches.register( 'Remove', '-remove',isRequired=True )
...
_.appInfo[focus()] = {
	...
	'description': 'Removes strings from a list. Add a prefix, if needed',
	'categories': [
						'file',
						'pipe',
						'replace',
	...
	'examples': [
						'2 --c | p removeFromLine -remove D:\\tech\\programs\\webApps\\samples\\ \\index.js -prefix " - "',
						'',
	],
	'columns': [
