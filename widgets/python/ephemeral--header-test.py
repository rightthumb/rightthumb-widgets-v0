...
_.appInfo[focus()] = {
	...
	'examples': [
						_.hp('p ephemeral--header-test + 123'),
...
def action():
	...
	url = 'https://eyeformeta.com/apps/server/?test=1'
	headers = {
		'api': '123'
	}

	response = requests.get(url, headers=headers)  # For a GET request
	for line in response.text.split('\n'):
		if _.showLine(line):
			print(line)

	# If you were making a POST request:
