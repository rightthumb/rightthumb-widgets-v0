...
def to_bytes(size_str):
    if 'Kb' in size_str:
        size_str = size_str.replace('Kb', 'kbit')
    if 'Mb' in size_str:
        size_str = size_str.replace('Mb', 'mbit')
    if 'Gb' in size_str:
        size_str = size_str.replace('Gb', 'gbit')
    if 'Tb' in size_str:
        size_str = size_str.replace('Tb', 'tbit')
    if 'Pb' in size_str:
        size_str = size_str.replace('Pb', 'pbyte')
    if 'Eb' in size_str:
        size_str = size_str.replace('Eb', 'ebyte')
    if 'Zb' in size_str:
        size_str = size_str.replace('Zb', 'zbyte')
    if 'Yb' in size_str:
        size_str = size_str.replace('Yb', 'ybyte')
    size_str = size_str.lower()
    unit_map = {'b': 1, 'kb': 1024, 'mb': 1024 ** 2, 'gb': 1024 ** 3, 'tb': 1024 ** 4, 'pb': 1024 ** 5, 'eb': 1024 ** 6, 'zb': 1024 ** 7, 'yb': 1024 ** 8, 'byte': 1, 'kbyte': 1024, 'mbyte': 1024 ** 2, 'gbyte': 1024 ** 3, 'tbyte': 1024 ** 4, 'pbyte': 1024 ** 5, 'ebyte': 1024 ** 6, 'zbyte': 1024 ** 7, 'ybyte': 1024 ** 8, 'kbit': 1024 / 8, 'mbit': 1024 ** 2 / 8, 'gbit': 1024 ** 3 / 8, 'tbit': 1024 ** 4 / 8, 'pbit': 1024 ** 5 / 8, 'ebit': 1024 ** 6 / 8, 'zbit': 1024 ** 7 / 8, 'ybit': 1024 ** 8 / 8, 'bit': 1 / 8}
    try:
