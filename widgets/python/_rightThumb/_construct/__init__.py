...
#abc123 start new
class Line:
    def __init__(self, switches, switch_dict=None, run=-1):
    ...
    def setSwitches(self):
        ...
        for switch in switch_names:
            if self.switches.isActive(switch):
    ...
    def show(self, string, *args, **kwargs):
        ...
        minus = self.switch_dict.get('Minus', [])
        if len(args) > 1:
            minus = args[1]
        if 'Minus' in kwargs:
            minus = kwargs['Minus']
    ...
    def getPlusInput(self, plus, plusOr, OR):
        ...
        if plus != '':
            ...
            plusInput = self.switch_dict.get('Plus', []).copy()
        return plusInput
    ...
    def getMinusInput(self, minus):
        ...
        if minus != '':
            ...
            return self.switch_dict.get('Minus', [])
