...
def appSwitches():
	_.switches.register( 'Lines', '-lines', '20 000' )
	pass
	### EXAMPLE: START
...
_.appInfo[focus()] = {
	'file': 'terminalTest.py',
	'liveAppName': __.thisApp( __file__ ),
	'description': 'Test terminal lines capability',
	'categories': [
						'terminal test',
						'terminal',
						'test',
...
def action():
	if _.switches.isActive('Lines'):
		lines = int(''.join( _.switches.values('Lines') ))
	else:
		lines = 900
