...
_.appInfo[focus()] = {
	...
	'description': [
						'Interact with DnD database of wizard spells',
	...
	'examples': [
						'p wizard -prep',
						'p wizard -selected 14 18 19 20 28 36 39 41    10 15 22 34',
						'p wizard -t 10 15 22 34 ',
						'p wizard ',
						'',
						'p wizard -ss ',
						'',
						...
						'',
						'',
						['p wizard -c t sel l n -g t sel','red'],
						'',
						['p wizard -c sel t i n l de r du  -g sel t','red'],
						'',
						'p wizard -c selected type i name level damage-effect range duration dice -g selected type',
						'',
						'',
						'p wizard -prep',
						'p wizard -selected 14 18 19 20 28 36 39 41',
						'p wizard -t 10 15 22 34',
						'p wizard -t 10 15 22 34',
						'p wizard',
						'',
						...
						'',
						'p wizard -history',
						'p wizard -history -ago 1w',
						'p wizard -history -ago 1w one',
						'',
						'',
	],
	'columns': [
...
def prepData():
	...
	_.saveTableDB( data, 'wizard.json' )
...
def action():
	...
	#     spell_slots = []
	#     _.saveTableDB( spell_slots, 'wizard_spell_book.json' )
	...
	#     _.saveTableDB( spell_history, 'wizard_spell_history.json' )
	#     _.saveTableDB( spell_slots, 'wizard_spell_book.json' )
...
def load():
	...
	data = _.getTableDB( 'wizard.json' )
	spell_slots = _.getTableDB( 'wizard_spell_book.json' )
	spell_history = _.getTableDB( 'wizard_spell_history.json' )
	if _.switches.isActive('PrepData'):
		prepData()
...
# p wizard -prep
# p wizard -selected 14 18 19 28 34 36 39 41
# p wizard -t 10 15 22
# p wizard -t 10 15 22
# p wizard
