...
_.appInfo[__name__]['examples'].append('dd | p line -p \ 1')
_.appInfo[__name__]['examples'].append('dd | p line -p \ e 2')
_.appInfo[__name__]['examples'].append('dd | p line -p \ "1;2;3"')
_.appInfo[__name__]['examples'].append('p f -papa + \GLENNALLEN\ \AppData\ - \Local\ . | p line --c -p \ 5 > ~dup.txt')
_.appInfo[__name__]['examples'].append('p f -dad + papa .jpg - 983db650f7f | p line --c -p \ ee > "~dup.txt"')
_.appInfo[__name__]['examples'].append('p f -pub + papa .jpg - 983db650f7f79bc8 | p line --c -p \ ee > "~dup.txt"')
_.appInfo[__name__]['examples'].append('type %f1% | p line -x %f2% \ 3')
_.appInfo[__name__]['examples'].append('type %f1% | p line -x %f2% \ 3 -xr')
_.appInfo[__name__]['examples'].append('type %f1% | p line -xu %f2% \ 5 - joomla')
_.appInfo[__name__]['examples'].append('p file + test --c | p line -make "move {}  D:\\\\tech\\\\hosts\\\\MSI\\\\programs\\\\python\\\\" | p execute')
_.appInfo[__name__]['examples'].append('p file + transaction  --c | p line --c -make "move {}  D:\\\\tech\\\\hosts\\MSI\\\\programs\\\\python\\\\" | p execute')
_.appInfo[__name__]['examples'].append('p file + bm- | p f + { -jn | p line --c -make "xcopy /d/y {} Default(bookmarks)\\" | p execute')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('type techfolder.txt | p line -xu temp_e.txt \ -xi build')
_.appInfo[__name__]['examples'].append('type file0.txt | p line -xu file1.txt \  5')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('t v | p line + piller | p line --c -p " " 1 | p line --c -make "t c {} 2018.04.12" | p execute')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('type IronMan4.ino | p line -nospaceclean -noclean -p // 0 > tmp.txt')
_.appInfo[__name__]['examples'].append('type Adafruit_NeoPixel.cpp  | p line + ( { - " if" " while" " for" " print" #')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('type data.adj | p line -p " " 4 [pipe] 1')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('type %tmpf0% | p line --c -make ";\'¶¶¶¶BaaseTabel: {}¶¶;\' & RelationInfo(;\'LINAC_ENG;\';;\'{};\')&"')
