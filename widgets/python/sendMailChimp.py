...
def action():
	...
	_browser.imp.project.open( 'https://login.mailchimp.com/' )
	_browser.imp.project.login( 'https://login.mailchimp.com/', 'theperformersnetwork', 'Dd102349p!', '#username', '#password' )
	...
	_browser.imp.project.open( 'https://us5.admin.mailchimp.com/campaigns/#f_bucket:recent;t:campaigns-list' )
	...
	while not isLoaded == 'complete':
		...
		time.sleep( 5 )
	time.sleep( 10 )
	_browser.imp.project.inject( """$("a[title='Conquer Week 5  Day 4       How did we do?   Final Videos']").click();""" )
	time.sleep( 10 )
	_browser.imp.project.inject( """$("[data-dojo-attach-event='click: openSendNowModal']").click();""" )
	time.sleep( 10 )
	_browser.imp.project.close()
	# _browser.imp.project.inject( """$("[data-dojo-attach-event='click: sendConfirmed']").click();""" )
########################################################################################
if __name__ == '__main__':
	action()
