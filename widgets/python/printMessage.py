...
def appSwitches():
	pass
	_.switches.register( 'Message', '-m,-message', '"-    Drive not connected"', isRequired=True )
	_.switches.register( 'Color', '-color', 'red', isRequired=True )
...
_.appInfo[focus()] = {
	...
	'examples': [
						'p printMessage -message "Error: " " The file is missing"  -color red yellow',
						'',
	],
	'columns': [
