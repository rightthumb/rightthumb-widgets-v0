...
def appSwitches():
	pass
	_.switches.register( 'Files', '-files' )
	_.switches.register( 'Folders', '-folders' )
...
_.appInfo[focus()] = {
	...
	'description': 'Returns list of dir contents',
	'categories': [
						'DEFAULT',
				],
	'relatedapps': [
	...
	'examples': [
						# [' _dirList = _.regImp( __.appReg, \'dirList\' ) ','red'],
						# '',
						# 'p dirList -p D:\\tech\\programs -folders',
						'',
	],
	'columns': [
				...
				if _.showLine(path):
					...
					if shouldPrint:
						if _.switches.isActive('Files'):
							payloadFiles.append( path )

			if os.path.isdir(path):
				if _.switches.isActive('Folders'):
					payloadFolders.append( path )
