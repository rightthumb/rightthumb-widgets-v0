...
_.appInfo[focus()] = {
	'file': 'convertList.py',
	'description': 'Convert text list to data list',
	'categories': [
						'convert',
						'text manipulation',
				],
...
# def cleanDoubleSlashes( data ):
#     newData = []
#     for line in data:
#         line = line.replace( _v.slash+_v.slash, _v.slash )
#         newData.append( line )
#     return newData
...
def action():
	...
	if os.path.isfile( f ):
		...
		setPipeData( text )
		pipeCleaner()
		# _.appData[__.appReg]['pipe'] = cleanDoubleSlashes( _.appData[__.appReg]['pipe'] )
		_.saveTable2( _.appData[__.appReg]['pipe'], _v.stmp + _v.slash+'_convertList-TMPFILE.json' )
