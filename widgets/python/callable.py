...
def sw():
    ...
    _.switches.register( 'Language', '-lan', 'py python php || defaults to auto by ext' )
...
class CallableExtractor:
    ...
    def action(self):
        ...
        if _.switches.isActive('Language'):
            self.Language = _.switches.value('Language').lower()
            lanNorm = {
                'py': 'python',
                'js': 'javascript',
            }
            if self.Language in lanNorm: self.Language = lanNorm[self.Language]
