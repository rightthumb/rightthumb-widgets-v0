...
def sw():
	pass
	### EXAMPLE: START
	_.switches.register( 'Replace', '-r,-i,-re,-replace', 'aa ab bb bc' )
...
def algorithm(string):
	if _.switches.isActive('Replace'):
		ln=len(_.switches.values('Replace'))
		rep=_.switches.values('Replace')
		i=-1
		done=False
		while not i==ln:
			i=i+1
			...
			string=string.replace(rep[i],rep[i+1])
			i=i+1
		return  string
