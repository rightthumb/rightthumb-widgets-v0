...
def appSwitches():
	...
	_.switches.register( 'RemoveDuplicateTabs', '-dup' )
...
_.appInfo[focus()] = {
	...
	'description': 'Convert tab delimited files to csv',
	'categories': [
						'convert',
						'convert file',
						'tab',
	...
	'examples': [
						'p tab2csv -f 2020_Meds.txt -dup -print',
						'p tab2csv -f 2020_Meds.txt -dup -save',
						''
	],
	'columns': [
...
def process( data ):
	if _.switches.isActive('RemoveDuplicateTabs'):
