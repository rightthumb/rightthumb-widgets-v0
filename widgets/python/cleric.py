...
def action():
	...
	if _.switches.isActive('ResetSpellSlots'):
		...
		spell_slots = {}
		_.saveTableDB( spell_slots, 'cleric_spell_slots.json' )
		_.saveTableDB( spell_history, 'cleric_spell_history.json' )
...
def load():
	...
	data = _.getTableDB( 'cleric.json' )
	spell_slots = _.getTableDB( 'cleric_spell_slots.json' )
	spell_history = _.getTableDB( 'cleric_spell_history.json' )
