...
__.the_file=_.switches.value('Files').replace(os.sep+os.sep,os.sep)
...
def action():
	...
	_.saveText(change(c3po,i,to),__.the_file)
	_.pr(__.the_file)
	backup(__.the_file)
...
def load():
	global c3po
	c3po = _.getText( __.the_file, raw=True )
	_.pr(__.the_file)
