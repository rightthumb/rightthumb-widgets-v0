...
def sw():
    _.switches.register('Action', '-action')
    _.switches.register('Collection', '-collection')
    _.switches.register('Language', '-language')
    _.switches.register('Description', '-description')
    _.switches.register('Snippet', '-snippet')
    _.switches.register('Tags', '-tags')
    _.switches.register('Tag', '-tag')
...
def action():
    ...
    api = _v.fig['snippet-api-key']
    base_url = _v.fig['snippet']
