...
if __name__ == '__main__':
	...
	_.switches.register('Output', '-o','file2.json')

	_.appInfo=    {
		'file': 'jsonDefault.py',
		'description': 'default field order',
		'prerequisite': [],
		'examples': [],
		'columns': [],
		}

	_.appInfo['examples'].append('p jsonDefault -i file.json -o file2.json')
...
def action():
	...
	if _.switches.isActive('Output'):
		_.saveTable2(json,_.switches.value('Output'))
