...
_.appInfo[focus()] = {
	...
	'description': 'Search the backup log and print backup files',
	'categories': [
						'backup',
						'txtbackup',
						'txt',
	...
	'examples': [
						'p backupFiles + signature certificates shared.js',
						'p backupFiles + signature certificates shared.js | p f + resendEmailValidate -jn -notin --c',
						'',
						''
	],
	'columns': [
