...
def PC(ports): return ports.replace(' ','').replace(',,',',').split(',')
...
__.ports_hash = {
					...
					'20': PC('5000,9100,80, 21-23,25,53,110-111,135-139,143,443,445,993,995,1723,3306,3389,5900,8080,1701'),
					'200': {
...
if _.switches.isActive('Ridiculous'): __.ports_hash['200']['tcp']=PC('1-2000,4000-7000,8000-9000')
