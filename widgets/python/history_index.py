...
def load():
	...
	index_py_switches    = _.getTable( 'history_index[py-switches].index' )
	index_edit_py        = _.getTable( 'history_index[edit-py].index' )
	index_cmd            = _.getTable( 'history_index[cmd].index' )
	index_py             = _.getTable( 'history_index[py].index' )

	index_edit_files     = _.getTable( 'history_index[edit-files].index' )
	index_tickets        = _.getTable( 'history_index[tickets].index' )
	index_rename         = _.getTable( 'history_index[rename].index' )

	index_day            = _.getTable( 'history_index[day].index' )
	index_tickets_day    = _.getTable( 'history_index[tickets-day].index' )
	index_day_edit       = _.getTable( 'history_index[day-edit].index' )

	index_labs           = _.getTable( 'history_index[labs].index' )
