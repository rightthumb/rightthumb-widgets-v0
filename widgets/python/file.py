...
# --- JSON logic with plain substrings ---
CATEGORIES_JSON = """
{
  "categories": [
	{"name": "vps-internal", "patterns": ["vps-"]},
	{"name": "servers", "patterns": ["server", "server-", "system", "webserver", "httpd", "conf"]},
	{"name": "db", "patterns": ["sql", "sqlite", "db", "indexdb", "mdb"]},
	{"name": "os", "patterns": ["os", "unix", "linux", "windows", "powershell", "bashrc", "chmod", "system"]},
	{"name": "network", "patterns": ["dns", "ip", "ssh", "ssl", "port", "socket", "whois", "webdav", "http"]},
	{"name": "web-scrape", "patterns": ["web", "url", "scrape", "crawler", "har", "wiki", "webpage", "download"]},
	{"name": "security", "patterns": ["crypt", "encrypt", "decrypt", "unhackable", "secure", "key", "keylink"]},
	{"name": "media", "patterns": ["mp3", "ffmpeg", "audio", "video", "speak", "speech", "transcribe"]},
	{"name": "images", "patterns": ["exif", "image", "img", "pic"]},
	{"name": "archives", "patterns": ["zip", "7z", "tar", "gzip", "compress", "decompress", "en-zip"]},
	{"name": "data-files", "patterns": ["json", "yaml", "yml", "csv", "mime"]},
	{"name": "text", "patterns": ["line", "string", "word", "stem", "replace", "split", "join", "count", "find", "search", "print"]},
	{"name": "time", "patterns": ["date", "time", "epoch", "lunar", "stardate"]},
	{"name": "ai", "patterns": ["gpt", "ai", "openai", "prompt"]},
	{"name": "social", "patterns": ["youtube", "pinterest", "twitter", "facebook", "tiktok", "insta"]},
	{"name": "code", "patterns": ["code", "compile", "import", "module", "js", "class"]},
	{"name": "special", "patterns": ["bible", "dnd"]},
	{"name": "geo", "patterns": ["geo", "gps", "lon", "lat"]},
	{"name": "messaging", "patterns": ["sms", "twilio", "gmail", "email"]},
	{"name": "files", "patterns": ["file", "folder", "dir", "path", "ls2", "ls", "alias", "backup", "fi", "fo"]},
	{"name": "misc", "patterns": ["-"]}
  ]
}
"""

def categorize_files(filenames: List[str]) -> Dict[str, List[str]]:
	rules = json.loads(CATEGORIES_JSON)["categories"]
		...
		for cat in rules:
			for pat in cat["patterns"]:
				if pat and pat in lname:
					categories[cat["name"]].append(fname)
					matched = True
					break
			if matched:
				break
		if not matched:
			categories["uncategorized"].append(fname)

	# pretty print tabbed out
