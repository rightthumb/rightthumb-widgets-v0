...
def appSwitches():
	_.switches.register('FormatSize', '-f,-size')
	_.switches.register('Round', '-r,-round')
...
_.appInfo[focus()] = {
	'file': 'addList.py',
	'description': 'adds a piped list of numbers',
	'categories': [
						'math',
						'add',
						'file',
...
_.appInfo[focus()]['examples'].append('p addList -file file.txt')
