...
def sw():
    _.switches.register('DB', '-db, +db')
    _.switches.register('Collection', '+c,-collection')

    _.switches.register('Create', '--c,-create')
    _.switches.register('Read', '--r,-read')
    _.switches.register('Search', '--s,-search')
    _.switches.register('Update', '--u,-update')
    _.switches.register('Delete', '--d,,-del,-delete')

    _.switches.register('ID', '-id')
    _.switches.register('Fields', '-f,-fields')

    _.switches.register('Config', '-config', 'config.yml')
    _.switches.register('URL', '-url')
    _.switches.register('APIKey', '-key,-api-key')
