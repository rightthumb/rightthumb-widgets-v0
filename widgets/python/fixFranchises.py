...
if __name__ == '__main__':
	...
	_.appInfo['examples'].append('p fixFranchises')
...
def action():
	...
	# franchiseData2 = _.getTable('imdb_franchises.json3')

	item1 = 'marvel'

	dc = list(set(franchiseData[0]['dc']))
	marvel = list(set(franchiseData[0]['marvel']))
	franchiseData[0]['marvel'] = marvel
	franchiseData[0]['dc'] = []
	for x in dc:
		if not x in franchiseData[0]['marvel']:
			franchiseData[0]['dc'].append(x)
