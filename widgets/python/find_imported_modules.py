...
def find_imports_in_file(file_path):
	...
	import_pattern = r'^\s*from\s+\S+\s+import\s+\S+|^\s*import\s+\S+'
	imports = re.findall(import_pattern, content, re.MULTILINE)

	return imports

def find_imports_in_folder(folder_path, recursive=False):
	import_statements = []
...
def action():
	...
	folder_path = 'D:\\.rightthumb-widgets\\widgets\\python'
	# recursive = input("Search recursively? (y/n): ").lower() == 'y'
	recursive = True
	import_statements = find_imports_in_folder(folder_path, recursive)
