...
if test:
	...
	from globals_export import globals_bundle_export   # type: ignore

	# from library.beta.app_code_export_import import globals_bundle_export  # or whatever your path is

	res = globals_bundle_export(globals(), recurse=True, include_imports=True, include_globals=True)
	print(res["support_path"])
	print(res["shim"])
	if res["notes"]:
		print("NOTES:")
		for n in res["notes"]:
