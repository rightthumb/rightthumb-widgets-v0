...
if __name__ == '__main__':
	...
	_.appInfo['examples'].append('p auditCSS -file style.css')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('p auditcss -f responsive2.css + .resumeItem - " "')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('')


	_.appInfo['examples'].append('p auditcss -f responsive2.css + #edubody .resumeItem -attrib > %tmpf6%')
	_.appInfo['examples'].append('n %tmpf6%')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('type %tmpf6% | p line - "@" "." #')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('p auditcss -html %tmpf6% -f style.css -attrib')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('p auditcss -html %tmpf6% -f style1.css -attrib -issue')
	_.appInfo['examples'].append('p auditcss -html %tmpf6% -f style1.css -attrib -issue width')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('p auditcss -f css/responsive.css -attrib height + cert')
	_.appInfo['examples'].append('')
	_.appInfo['examples'].append('')
