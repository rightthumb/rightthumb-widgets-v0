...
_.appInfo[__name__] = {
	'file': 'auditCSS.py',
	'description': 'Audit css file, cross reference html and css, help troubleshoot',
	'prerequisite': [],
	'examples': [],
	'columns': [],
	}
...
_.appInfo[__name__]['examples'].append('p auditCSS -file style.css')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('p auditCSS -f responsive2.css + .resumeItem - " "')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('')


_.appInfo[__name__]['examples'].append('p auditCSS -f responsive2.css + #edubody .resumeItem -attrib > %tmpf6%')
_.appInfo[__name__]['examples'].append('n %tmpf6%')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('type %tmpf6% | p line - "@" "." #')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('p auditCSS -html %tmpf6% -f style.css -attrib')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('p auditCSS -html %tmpf6% -f style.css -attrib -issue')
_.appInfo[__name__]['examples'].append('p auditCSS -html %tmpf6% -f style.css -attrib -issue width')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('p auditCSS -f css/responsive.css -attrib height + cert')
_.appInfo[__name__]['examples'].append('')
_.appInfo[__name__]['examples'].append('')
