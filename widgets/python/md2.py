...
def sw():
	...
	# _.switches.register( 'Files', '-f,-fi,-file,-files','file.txt', isData='data', description='Files', isRequired=True )
...
def action():
	...
	html_as_a_string = gh_md_to_html.core_converter.markdown(t)
	_.pr(html_as_a_string)
