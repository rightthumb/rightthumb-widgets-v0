...
_.appInfo[focus()] = {
	'file': 'clickLinksInFiles.py',
	'liveAppName': __.thisApp( __file__ ),
	'description': 'Unsubscribe to everything',
	'categories': [
						'outlook',
						'email',
						'unsubscribe',
	...
	'examples': [
						'p file --c + _email___ | p clickLinksInFiles',
						'',
						'p clickLinksInFiles -f _email___asi-enews.com.txt',
						'',
	],
	'columns': [
...
def process( path=None, link=None ):
	global urli
	if not path is None:
