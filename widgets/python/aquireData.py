...
def appSwitches():
	_.switches.register('Page', '-page','https://agar.io/')
	_.switches.register('Payload', '-payload','core')
	_.switches.register('Inject', '-inject','agario')



_.appInfo[focus()] = {
	'file': 'aquireData.py',
	'description': 'Aquire payload data',
	'categories': [
						'front end',
						'hack',
						'javascript',
	...
	'examples': [
						'p aquireData -page "https://agar.io/" -payload core -inject agario',
						''
	],
	'columns': [
