...
if _.switches.isActive('PrintDelimLines'):
	...
	print( '____________________ ____________________ ____________________ ____________________' )
	sys.exit()
					...
					if _.switches.isActive('Original'):
						if _.switches.isActive('Plus'):
							...
							for plusSearchX in _.switches.values('Plus'):
								...
								# 		print( len(plusSearchX)-1, len(thePrintLine)-1, scanning )
						...
						# print(_.inlineBold(theLineNumber+1),thePrintLine)
						print(_.inlineBold(theLineNumber),thePrintLine)
					else:
						if _.switches.isActive('Plus'):
							thePrintLine = line
							for plusSearchX in _.switches.values('Plus'):
