...
def generate_teleport_points(grid_size, max_range):
    ...
    for x in range(-steps, steps + 1):
        for z in range(-steps, steps + 1):
            print(f"/tp @p {x * grid_size} {y_coordinate} {z * grid_size}")

if __name__ == "__main__":
    grid_size = int(input("Enter the grid size (e.g., 1000 for every 1000 blocks): "))
    max_range = int(input("Enter the maximum range in one direction (e.g., 5000 for -5000 to 5000): "))
