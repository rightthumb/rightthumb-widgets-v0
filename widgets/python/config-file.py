...
def appSwitches():
	...
	_.switches.register( 'Subject', '-subject', 'debian.vps' )
	_.switches.register( 'Subject', '-subject', 'centos.cpanel' )
...
def action():
	...
	elif not _.switches.isActive('Subject'):
		subject=input( 'centos.cpanel: ' )

	folder = _v.pp +os.sep+ 'configs'+os.sep+ os.sep.join( subject.split('.') )
