...
def appSwitches():
	_.switches.register( 'Thousand', '-t', '50' )
	_.switches.register( 'BreakOn', '-br', '100' )
	pass
	### EXAMPLE: START
...
def action():
	br = 100
	cnt = 10000
	if _.switches.isActive('Thousand'):
		cnt = _.switches.value('Thousand')+'000'
		cnt = int(cnt)
	if _.switches.isActive('BreakOn'):
		br = int(_.switches.value('BreakOn'))
