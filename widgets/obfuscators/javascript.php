<?php
if ($argc !== 3) {
    fwrite(STDERR, "Usage: php obfuscate.php input.php output.js\n");
    exit(1);
}
...
// JavaScript payload using pako and TextDecoder
$payload = <<<JS
// Requires: https://cdnjs.cloudflare.com/ajax/libs/pako/2.1.0/pako.min.js
...
echo "✅ JavaScript-wrapped obfuscated payload written to: $output\n";
