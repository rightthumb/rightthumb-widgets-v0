...
$px=$widgets+"\widgets\python\b.py"

# $cmdOutput = (python3 $px -a $args[0]) -join "`n"
$cmdOutput = $( python3 $px -a $args[0] )
# echo $cmdOutput
cd $cmdOutput
# Set-Location -Path $( python3 $px -a $args[0] ) -PassThru
# Set-Location -Path $( python3 $px -a $args[0] ) 
