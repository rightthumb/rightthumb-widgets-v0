...
Fixes:
  - WinSAT now runs through a safe wrapper that:
...
$PkgWinget["iperf3"] = "ESnet.iperf3"              # may vary; registry stays editable
...
function Mod-CPU {
    ...
    # Safe WinSAT call (no red errors, records reason in JSON)
