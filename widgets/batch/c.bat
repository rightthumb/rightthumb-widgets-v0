...
IF NOT ["%api%"] == ["loaded"] (
	...
	CALL:BUILD_TICKET_HISTORY >nul 2>&1
	CLS
)
...
rem SET widgets=%widgets%\widgets
...
SET behave=%behavior%
SET hack=%widgets%\widgets\javascript\website_hacks.js
SET tool.js=D:\websites\Reph.us\tools\tool.js
SET hacks=%hack%
...
SET pyi=D:\techApps\Python\Python36-32\index.txt
SET ps="D:\Program Files\Adobe\Adobe Photoshop CC 2014\Photoshop.exe"
...
SET 7z="D:\techApps\7-Zip\7zFM.exe"
