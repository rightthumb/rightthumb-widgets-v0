...
:LOAD
			...
			SET appPaths=%binWin%;%myPython%;%myBatch%\temp;%batch%\fw;%batch%\tools;%batch%\alias;%exe_folders%;%USERPROFILE%;%filemeta%;C:\Users\Scott\AppData\Roaming\npm
			...
			call pathClean.bat
			doskey p3="C:\Users\Scott\AppData\Local\Microsoft\WindowsApps\python3.exe" $*
			@REM call aliases.bat
