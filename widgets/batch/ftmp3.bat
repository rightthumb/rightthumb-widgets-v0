...
findstr /i /r %1 "%indexindex%"
GOTO END


:TWO
echo Search level: TWO variables
findstr /i /r %1 "%indexindex%" | find /i %2
GOTO END


:THREE
echo Search level: THREE variables
findstr /i /r %1 "%indexindex%" | find /i %2 | find /i %3
GOTO END


:FOUR
echo Search level: FOUR variables
findstr /i /r %1 "%indexindex%" | find /i %2 | find /i %3 | find /i %4
GOTO END


:FIVE
echo Search level: FIVE variables
findstr /i /r %1 "%indexindex%" | find /i %2 | find /i %3 | find /i %4 | find /i %5
GOTO END
