...
rem CALL p singleLine -f "%stmp%\unclaimed_tickets_history\history-%Session_ID%.txt" > "%fileTempData%"  2>&1
...
del "%stmp%\unclaimed_tickets_history\history-%ORIGINAL_Session_ID%.txt"
