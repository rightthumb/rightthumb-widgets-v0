...
if "%~3"=="" (
    if "%~2"=="" (
        ...
        curl -H "Title: !title!" -H "Priority: urgent" -H "Tags: !works!" -d "!message!" aleen.m-eta.app:52346/sds-notify
    ) else (
    ...
    curl -H "Title: !title!" -H "Click: !url!" -H "Priority: urgent" -H "Tags: !works!" -d "!message!" aleen.m-eta.app:52346/sds-notify
)
