...
if exist %* (
	...
	rem call p fileBackup -i %myTables%\%*.json
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myTables%\%*.txt
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %phpFiles%\%*.php
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %scriptroot%\%*.bat
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %powershell%\%*.ps1
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i D:\_Scott\S_Documents\Projects\self\Powershell\%*.ps1
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myPhp%\%*.php
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myPowershell%\%*.ps1
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myPython%\%*.py
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myTables%\%*
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myDatabases%\%*
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %myWebApp%\%*
	rem taskkill /im sublime_text.exe /f
	...
	rem call p fileBackup -i %USERPROFILE%\Desktop\%*
	rem taskkill /im sublime_text.exe /f
