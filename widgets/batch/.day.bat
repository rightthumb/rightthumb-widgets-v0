...
echo darkcyan 23 hours 59 minutes                    >> %tmpf%-print_color-day
echo cyan C:\Users\Scott\.rt\profile\daily\2022\29\07-24\                       >> %tmpf%-print_color-day
echo Background.green linePrint      >> %tmpf%-print_color-day
call p print_color -f %tmpf%-print_color-day -tab 2
cd C:\Users\Scott\.rt\profile\daily\2022\29\07-24\